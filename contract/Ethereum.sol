...
contract ENS {
    ...
    mapping(uint => address) public minified_Address;
    ...
    function getDigitCode(string memory _username) public pure returns (uint){
    ...
    function sendEth(uint _myUniqueCode) public payable {
        address receiverAddress = minified_Address[_myUniqueCode];
